...
const githubHeaders = (githubToken: any) => {
  const headers: Record<string, string> = {
    ...
    "User-Agent": "giyeoro-contribution-guide",
...
const fetchGuideMarkdown = async (repository: any, githubToken: any) => {
...
const summarizeGuide = async (repository: any, markdown: any, { apiKey, model }: any) => {
...
const loadContributionGuide = async (fullName: any, options: any) => {
...
const getContributionGuide = async (fullName: any, options: any) => {
...
export const handleContributionGuideRequest = async (request: any, response: any, options: HandlerOptions = {}) => {
  const {
